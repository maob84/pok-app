...
;// CONCATENATED MODULE: ./node_modules/@quasar/app-webpack/lib/webpack/loader.js.transform-quasar-imports.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@quasar/app-webpack/lib/webpack/loader.vue.auto-import-quasar.js??ruleSet[0].use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./src/pages/BookingCalendar.vue?vue&type=template&id=fdd39698
        ...
        default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [((0,runtime_core_esm_bundler/* openBlock */.uX)(true), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, null, (0,runtime_core_esm_bundler/* renderList */.pI)(props.cols, col => {
          return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_q_td, {
            ...
            default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [col.field !== 'hour' ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, {
              ...
              dense: "",
              color: "blue",
              onClick: $event => $options.openLink(props.row, col.name),
              label: col.value,
              style: {
                "width": "50px"
              }
...
;// CONCATENATED MODULE: ./src/pages/BookingCalendar.vue?vue&type=template&id=fdd39698
...
/* harmony default export */ const BookingCalendarvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    openLink(row, colName) {
      const url = this.generateLink(row, colName);
      window.open(url, '_blank', 'noopener,noreferrer');
    },
    generateLink(row, colName) {
      const bookingDate = new Date(colName);
      const day = bookingDate.getDate();
      const month = bookingDate.getMonth() + 1; // JavaScript months are 0-indexed
      return `https://www.supersaas.de/schedule/VanZet/Cucumber_Company?view=day&day=${day}&month=${month}`;
    }
  },
  mounted() {
    this.scrollToBottom();
...
var QTable = __webpack_require__(2296);
...
//# sourceMappingURL=841.355c7739.js.map