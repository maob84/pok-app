...
/* harmony default export */ const DebugInfovue_type_script_setup_true_lang_js = ({
  ...
  setup(__props) {
    ...
    const gitHash = (0,reactivity_esm_bundler/* ref */.KR)("\"06a53253e2b2370893698bc322cd72e731445ea3\"" || 0);
    const buildTimestamp = (0,reactivity_esm_bundler/* ref */.KR)("Sat, 24 Aug 2024 05:50:46 GMT" || 0);
    ...
    const apiURL = (0,reactivity_esm_bundler/* ref */.KR)("http://room.proben-ohne-krach.de:8000");
                ...
                default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_q_card, null, {
                  default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_q_card_section, null, {
                    default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_q_item_label, null, {
                      ...
                      default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createTextVNode */.eW)("API Url: " + (0,shared_esm_bundler/* toDisplayString */.v_)(apiURL.value), 1)]),
                      _: 1
                    })]),
                    _: 1
                  })]),
...
//# sourceMappingURL=650.4443b029.js.map